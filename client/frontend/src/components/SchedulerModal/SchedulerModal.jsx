...
const CustomDateInput = React.forwardRef(({ value, onClick }, ref) => (
  <div className="date-time-field" onClick={onClick} ref={ref}>
...
export default function SchedulerModal({
  ...
  const handleCreateLab = async (e) => {
    ...
    try {
      await createLaboratorio({
        identificador: newLabIdentifier,
        tipo: newLabType,
      });
      ...
      const errorMsg =
        err.response?.data?.error || "Erro ao criar o laboratório.";
      setError(errorMsg);
    } finally {
  ...
  const handleAgendar = async (e) => {
    ...
    const dadosReserva = {
      ...
      data_inicio: formatToLocalISO(dataInicio),
      data_fim: formatToLocalISO(dataFim),
      anotacoes,
          ...
          <Tab eventKey="agendar" title="Agendar">
            <Form onSubmit={handleAgendar} className="p-2">
              ...
              <Button
                ...
                type="submit"
                disabled={isSubmitting || !selectedLabId}
              >
          ...
          <Tab eventKey="criar" title="Criar Laboratório">
            <Form onSubmit={handleCreateLab} className="p-2">
              ...
              <InputGroup className="input-group-custom mb-3">
                ...
                <Form.Control
                  placeholder="Identificador (Nome ou Número)"
              ...
              <Button
                className="btn-agendar mt-3"
                type="submit"
                disabled={isSubmitting || !newLabType}
              >
                {isSubmitting ? "A criar..." : "Criar Laboratório"}
              </Button>
            </Form>
          </Tab>
        </Tabs>
